...
<head>
	...
	<title>Envanter Testleri | İK Uygulamaları - dakik Mühendislik & Bilişim</title>
						...
						<div class="row m-0" style="display: none; " id="div2">
							...
							<div class="row m-0">
								...
								<div class="col-md-4 pb-3">
                                    ...
                                    <label class="btn btn-sm btn-outline-primary" style="padding: .25rem; margin-right: .5rem" for="inputGender">Erkek</label>
